...
class LoggingMessages:
    ...
    WELCOME = "Seja bem vindo(a) ao script Sentinela.\nVersão atual: {version}\tLogin: {login}"
    ...
    MESSAGE_SENDED = "Mensagem enviada"
    ...
    FILE_BUSY = "O arquivo '{file}' está ocupado novamente, tentando novamente em 2 minutos."
